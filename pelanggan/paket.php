...
<body>
    ...
    <div class="xcontainer d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="container-fluid bg-white wrapper row ps-3 pt-4 px-0 rounded-4 shadow">
            <div class="logo-inet col-2">
                <img src="../assets/logo-inet.png" alt="Logo Internet" width="150px">
            </div>
            <div class="col-10 d-flex flex-column align-items-center justify-content-center ps-5">
                <h3 class="mt-5 fw-bold">SELAMAT DATANG</h3>
                    ...
                    <div class="list-paket d-flex gap-3 me-5 mt-3">
                        ...
                        <div class="paket border">
                            ...
                            <div class="paket-body fw-bold fs-5 pt-5 pb-3 ps-3">
                                ...
                                <p>Unlimited</p>
                                <div class="text-center">
                                    <input type="radio" name="paket" value="platinum">
                                </div>
                            </div>
                        </div>
                        <div class="paket border">
                            ...
                            <div class="paket-body fw-bold fs-5 pt-5 pb-3 ps-3">
                                ...
                                <p>Unlimited</p>
                                <div class="text-center">
                                    <input type="radio" name="paket" value="diamond">
                                </div>
                            </div>
                        </div>
                    </div>
